          ...
          <div className={topPanelStyles.topPanel}>
            ...
            <div className={topPanelStyles.searchButton}>
              <svg width="20" height="20" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.0214844 4.50196C0.0214844 6.98242 2.04101 9.00196 4.52148 9.00196C5.58007 9.00196 6.54492 8.61915 7.31445 8.00196L12.291 12.9785L13.002 12.2754L8.02148 7.29492C8.63867 6.52539 9.02148 5.56054 9.02148 4.50195C9.02148 2.02148 7.00195 0.0019455 4.52148 0.0019455C2.04101 0.0019455 0.0214844 2.02149 0.0214844 4.50196ZM1.02148 4.50196C1.02148 2.56446 2.58398 1.00196 4.52148 1.00196C6.45898 1.00196 8.02148 2.56446 8.02148 4.50196C8.02148 6.43946 6.45898 8.00196 4.52148 8.00196C2.58398 8.00196 1.02148 6.43946 1.02148 4.50196Z" fill="black" />
              </svg>
            </div>
            ...
            <div className={topPanelStyles.newSlideMaketButton}>
              <svg width="21" height="11" viewBox="0 0 21 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.30002 5.70002C7.83336 8.63336 10.1 10.9 10.5 10.9C10.9 10.9 13.1667 8.63336 15.7 5.70002L20.1 0.500024H10.5H0.900024L5.30002 5.70002Z" fill="black" />
              </svg>

            </div>
            <div className={topPanelStyles.undoButton}>

            </div>
            <div className={topPanelStyles.redoButton}>
            ...
            <div className={topPanelStyles.chooseButton}>
              <svg width="21" height="21" viewBox="0 0 27 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path opacity="0.782" fill-rule="evenodd" clip-rule="evenodd" d="M0 0.999994C1.3734 0.843314 2.7068 1.00998 4 1.49999C10.8638 8.69829 18.0305 15.5316 25.5 22C25.99 23.2932 26.1567 24.6266 26 26C23.0178 25.6044 20.3511 26.2711 18 28C19.8604 31.5825 21.5271 35.2492 23 39C20.3973 42.423 17.064 43.423 13 42C11.6026 38.2056 9.9359 34.5389 8 31C5.9763 33.7057 3.3097 35.039 0 35C0 23.6667 0 12.3333 0 0.999994ZM3 6.99999C8.4969 12.3292 14.1635 17.4958 20 22.5C17.6902 22.9966 15.3568 23.1633 13 23C13.6565 28.1539 15.3232 32.9873 18 37.5C17.5 38 17 38.5 16.5 39C14.7635 34.9578 12.9301 30.9578 11 27C8.0717 25.7123 5.5717 26.379 3.5 29C3.0003 21.6742 2.8337 14.3409 3 6.99999Z" fill="black" />
              </svg>
